...
<div class="container">
    <form class="registration" method="POST" action="${pageContext.request.contextPath}/createUser">
        <h1>Registration Form</h1>
        <p style="color: red;" align="center">${errorString} </p>
        <label for="email">
            <span>Username</span>

            <input onkeydown="function1()" type="text" id="email" name="email" value="${user.email}" minlength="3" required>
        ...
        <label for="number">
            ...
            <input onkeydown="function1()" type="text" id="number" name="number" value="${user.number}" minlength="3" required>
        ...
        <label for="password">
            ...
            <input type="password" id="password" onkeydown="function1()"
                   maxlength="100" minlength="8" name="password" required  value="${user.password}">
        ...
        <label for="password_repeat">
            ...
            <input  onkeydown="function1()" type="password" id="password_repeat" name="password_repeat" maxlength="100" minlength="8" required>
        </label>
